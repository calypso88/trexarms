package com.calypso88.trexarms {
	 ...
	 * 
	 *  <p>For the simplest implementation, you can call Pulsar.registerCallback
	 ...
	 *  possible to create one or more independent Pulsar instances and access
	 *  its methods directly.</p>
	 */
	public final class Pulsar extends Sprite {
		...
		//--------------------------------------
			...
			//  Holds the singleton
			private static const instance:Pulsar = new Pulsar();
		...
		//--------------------------------------
			...
			public function Pulsar(){
				super();
				if(!instance) trace('[T-Rex Arms]: Pulsar initialized, v.' + VERSION);
			}
		...
		//--------------------------------------
			 ...
			 */
			public static function get pulseTime():int{
				return instance.pulseTime;
			}
			 ...
			 *  tick rather than the time of the current frame. 
			 */
			public function get pulseTime():int{
